...
public class RequestsArrayAdapter extends ArrayAdapter<Data.Request>
{
    private final Context context;
    private final List<Data.Request> values;

    public RequestsArrayAdapter(Context context, List<Data.Request> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(values.get(position).offername);
        textView2.setText(values.get(position).usernameWhoRequest);
        textView3.setText(values.get(position).requestDate);
